...
export const Rate = (props: IRateProps) => {
  ...
  const { rateList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="rate-heading">
        Đánh giá
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${rate.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${rate.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
      ...
      {props.totalItems ? (
        <div className={rateList && rateList.length > 0 ? '' : 'd-none'}>
